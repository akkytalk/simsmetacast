...
function CreateImport(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    user.append("sales_confirmation_id", id);
    ...
    props.postImportSalesContractData(data, user, toggle, setSubmitting);
    return;
  };
  ...
  return (
    <Card>
      ...
      <CardFooter>
        {props.importSalesContract.isPostLoading && <LinerLoader />}
      </CardFooter>
    </Card>
  );
}
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateImport);
