...
function CreatePurchaseOrder(props) {
  ...
  const quantity = purchaseOrderData[0]?.quantity;
  ...
  console.log(`client data`, props.suppiler);
  return (
    <Card className="m-3">
      <CardBody>
        <div style={{ overflow: "scroll" }}>
          <Table className="bg-white table">
            ...
            <tbody>
              <tr>
                <td>{purchaseOrderData[0]?.ref_no}</td>
                <td>
                  <DateFormat data={purchaseOrderData[0]?.booking_date} />{" "}
                </td>
                <td>{purchaseOrderData[0]?.customer?.company_name}</td>
                <td>{purchaseOrderData[0]?.supplier?.company_name}</td>
                <td>{purchaseOrderData[0]?.remarks}</td>
                <td>
                  {purchaseOrderData[0]?.quality}/
                  {purchaseOrderData[0]?.quantity}/{purchaseOrderData[0]?.price}
                </td>

                <td>{purchaseOrderData[0]?.commission_from_supplier}</td>
              </tr>
            </tbody>
          </Table>
        </div>
        ...
        <Formik
          initialValues={{
            ...
            company_name: purchaseOrderData[0]?.company_name ?? "",
            supplier_id: purchaseOrderData[0]?.supplier_id ?? "",
            customer_id: purchaseOrderData[0]?.customer_id ?? "",
            suppiler_name: purchaseOrderData[0]?.supplier?.company_name,
            supplier_address: purchaseOrderData[0]?.supplier_address ?? "",
            supplier_bank: purchaseOrderData[0]?.supplier_bank ?? "",
            shipment_from: "",
            shipment_to: "",
            port_discharge_id: "",
            country_loading_id: "",
            ...
            commission_from_supplier:
              purchaseOrderData[0]?.commission_from_supplier ?? "",
            email_subject: "",
            email_date: "",
            sent_to: "",
            commission_type:
              purchaseOrderData[0]?.commission_from_supplier_type ?? "",
            psic: 1,
            psic_detail: "",
            insurance: 1,
            insurance_detail: "",
                ...
                indent_details: [
                  {
                    ...
                    price: {
                      is_lme:
                        purchaseOrderData[0]?.is_fixed == 1
                          ? 1
                          : purchaseOrderData[0]?.is_fixed == 2
                          ? 2
                          : 0,
                      amount: "",
                      percent: "",
                      ...
                      amount_unit: "",
                      quantity_unit_id: "",
                      provisional_price: purchaseOrderData[0]?.value ?? "",
                      price_name: "",
                      price_analysis: [
                        // {
                        //   id: "",
                  ...
                  <Col md={4}>
                    ...
                    >
                      ...
                      {props.suppiler?.map((company) => {
                        if (
                          company.group_name ==
                          purchaseOrderData[0]?.customer?.group_name
                          //   ||
                          // company.group_name ==
                          //   purchaseOrderData[0]?.supplier?.group_name
                        )
                          return (
                ...
                <div className="p-2">
                  ...
                  <Row className="form-group ">
                    ...
                    <Col md={4}>
                      ...
                      >
                        {purchaseOrderData[0]?.supplier?.address?.map(
                          (addr) => {
                            return (
                    ...
                    <Col md={4}>
                      ...
                      >
                        {purchaseOrderData[0]?.supplier?.address
                          ?.filter(
                            (addr) =>
                ...
                {/* <Card className="m-2 test">
                  ...
                  {formProps.values.email_ref && (
                    <CardBody className="email-ref">
                      <EmailRef
                        orderId={purchaseOrderData[0]?.bpo?.id}
                        data={purchaseOrderData[0]?.bpo}
                      />
                    </CardBody>
                  )}
                </Card> */}
