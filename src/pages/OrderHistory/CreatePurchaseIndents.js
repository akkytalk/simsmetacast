...
import WordsDocsCreatePurchaseIndents from "../wordDocuments/WordsDocsCreatePurchaseIndents";
...
function CreatePurchaseIndents(props) {
  const { id } = useParams();
            ...
            return (
              <Form className="">
                ...
                <Row style={{ justifyContent: "center" }}>
                  ...
                  <Col md={2}>
                    <WordsDocsCreatePurchaseIndents
                      print
                      ...
                      commodity_value={`${
                        ...
                        purchaseSalesIndentData[0]?.commodity_details[0]
                          ?.container_no
                      } FCL, ${purchaseSalesIndentData[0]?.bpo?.quality}`}
                      customer_name={
                      ...
                      // fax_no={formProps.values.ref_no}
                      payment_advance={
                        purchaseSalesIndentData[0]?.payment_advance_type == "%"
                          ? Number(
                      ...
                      // shipper={formProps.values.shipper_name}
                      hs_code={
                        purchaseSalesIndentData[0]?.commodity_details?.length >
                        0
                          ? purchaseSalesIndentData[0]?.commodity_details[0]
